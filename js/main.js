...
window.onload=function(){
    ...
    var oRotate=oLeft.querySelector('ul');
    var oT=true;
    oRotate.onclick=function(){
        if(oT){
            oLeft.style.height='70px';
        }else{
            oLeft.style.height='350px';
        }
        oT=!oT;
    };
    //左侧点击跳转
    ...
    //右侧点击跳转
    var aRight=document.querySelectorAll('.right-content ul li');
    aRight[3].onclick=function(){
        iNow=0;
        oScreen.style.top=-iNow*document.documentElement.clientHeight+'px';
    };
};